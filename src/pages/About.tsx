      ...
      <main className="flex-1">
        <section className="bg-gradient-to-br from-primary/10 via-secondary/10 to-accent/10 py-20">
          <div className="container mx-auto px-4">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">О компании LuxLight</h1>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  LuxLight начала свой путь в 2014 году как небольшой магазин освещения в центре Москвы. 
                  С тех пор мы выросли в крупнейшую сеть, предлагающую широкий ассортимент светильников 
                  для дома и офиса.
                </p>
                <p>
                ...
                <p>
                  Сегодня LuxLight — это команда профессионалов, которые любят свое дело и готовы 
